# SETUP Tool By TEAM S-H-T 

# Author 
![Screenshot](https://github.com/Saikohackerteamrm/SETUP/blob/main/20250805_144429.jpg)
...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/SETUP
    $ cd SETUP
    $ python Mithila.py
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/SETUP && cd SETUP && python Mithila.py
 ### Hi there 👋
